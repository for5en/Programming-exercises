...
type ('s, 'r) _menhir_state = 
  ...
  | MenhirState40 : ((('s, _menhir_box_main) _menhir_cell1_SUM _menhir_cell0_IDENT, _menhir_box_main) _menhir_cell1_mexpr, _menhir_box_main) _menhir_state
    (** State 40.
        Stack shape : SUM IDENT mexpr.
        Start symbol: main. *)

  | MenhirState42 : (((('s, _menhir_box_main) _menhir_cell1_SUM _menhir_cell0_IDENT, _menhir_box_main) _menhir_cell1_mexpr, _menhir_box_main) _menhir_cell1_mexpr, _menhir_box_main) _menhir_state
    (** State 42.
        Stack shape : SUM IDENT mexpr mexpr.
        Start symbol: main. *)
...
include struct
  ...
  and _menhir_run_43 : type  ttv_stack. (((ttv_stack, _menhir_box_main) _menhir_cell1_SUM _menhir_cell0_IDENT, _menhir_box_main) _menhir_cell1_mexpr, _menhir_box_main) _menhir_cell1_mexpr -> _ -> _ -> _ -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _tok ->
      ...
      let e3 = _v in
      let _v = _menhir_action_16 e1 e2 e3 x in
      _menhir_goto_mexpr _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok
  
  and _menhir_run_41 : type  ttv_stack. (((ttv_stack, _menhir_box_main) _menhir_cell1_SUM _menhir_cell0_IDENT, _menhir_box_main) _menhir_cell1_mexpr as 'stack) -> _ -> _ -> _ -> ('stack, _menhir_box_main) _menhir_state -> _ -> _menhir_box_main =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
