...
class Ksiazka implements Serializable
{
    ...
    Ksiazka(String tytul, int rokpowstania, Pisarz... autorzy)
    {
        // KONSTRUKTOR PRZYJMUJE AUTOROW
        this.tytul = tytul;
        this.rokpowstania = rokpowstania;
    ...
    public String toString()
    {
        ...
        if(!autorzy.isEmpty()) return tytul + " autorstwa " + autorstwo.substring(0, autorstwo.length()-2);
        else return tytul;
    }
}
...
class Pisarz implements Serializable
{
    ...
    Ksiazka napisz(String tytul, int rokpowstania, Pisarz... autorzyTab)
    {
        ArrayList<Pisarz> autorzy = new ArrayList<Pisarz>();
...
class BazaDanych implements Serializable {
    ...
    public static BazaDanych wczytaj() {
        try (ObjectInputStream in = new ObjectInputStream(new FileInputStream(PLIK))) {
            ...
            System.out.println("Nie znaleziono pliku, tworzenie przykładowych danych...");
    ...
    private static BazaDanych stworzPrzykladoweDane() {
        ...
        Wydawnictwo w2 = new Wydawnictwo("Szybkie Litery", 190);
        Wydawnictwo w3 = new Wydawnictwo("ABCD", 2000);
        Wydawnictwo w4 = new Wydawnictwo("eloelo", 10);
        Wydawnictwo w5 = new Wydawnictwo("fajneksiazki", 4000);
        baza.obserwatorzy.add(w1);
        baza.obserwatorzy.add(w2);
        baza.obserwatorzy.add(w3);
        baza.obserwatorzy.add(w4);
        baza.obserwatorzy.add(w5);

        // Pisarze
        Pisarz p1 = new Pisarz("Adam Niemickiewicz", 2000, w1,w2,w5);
        Pisarz p2 = new Pisarz("Juliusz nieslowacki", 2200, w1,w3,w4);
        Pisarz p3 = new Pisarz("Jan Kowalski", 1212, w1, w2);
        baza.pisarze.add(p1);
        baza.pisarze.add(p2);
        baza.pisarze.add(p3);

        // Ksiazki
        Ksiazka k1 = p1.napisz("Aisd", 182, p2,p3);
        Ksiazka k2 = p2.napisz("Ocaml", 1212, p3);
        Ksiazka k3 = p3.napisz("Kurs tanca", 122, p1);
        Ksiazka k4 = p3.napisz("Abecadlo", 0);
        baza.ksiazki.add(k1);
        baza.ksiazki.add(k2);
        baza.ksiazki.add(k3);
        baza.ksiazki.add(k4);
    ...
    public static void main(String[] args)
    {
        ...
        ksiazki_ed.addActionListener(new ActionListener() 
        {
        	public void actionPerformed(ActionEvent e)
        	{
                ...
                ksiazkiFrame.setLayout(new GridLayout(2,1));
                ...
                wybor.addActionListener(
        	        new ActionListener()
        	        {
        	            public void actionPerformed(ActionEvent e) 
        	            {
        	        		...
        	        		ksiazkaFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); 
                ...
                JButton dodaj = new JButton("Dodaj nowa ksiazke");
                dodaj.addActionListener(
                	new ActionListener()
                	{
                		public void actionPerformed(ActionEvent e) 
        	            {
        	                Ksiazka k = new Ksiazka("", 0);
        	                baza.ksiazki.add(k);
        	                JFrame nowaFrame = new JFrame("Dodanie ksiazki");
        	                nowaFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        	                nowaFrame.setSize(400,300);
        	                
        	                JPanel nowaPanel = new KsiazkaSwing(k, baza);
        	                nowaFrame.add(nowaPanel);
        	                nowaFrame.setVisible(true);
        	            }
                	});
                ksiazkiFrame.add(dodaj);
        ...
        pisarze_ed.addActionListener(new ActionListener() 
        {
        	public void actionPerformed(ActionEvent e)
        	{
        		...
        		pisarzeFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                pisarzeFrame.setSize(600, 100);
                pisarzeFrame.setLayout(new GridLayout(2,1));
                ...
                wybor.addActionListener(
        	        new ActionListener()
        	        {
        	            public void actionPerformed(ActionEvent e) 
        	            {
        	        		...
        	        		pisarzFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                ...
                JButton dodaj = new JButton("Dodaj nowego pisarza");
                dodaj.addActionListener(
                	new ActionListener()
                	{
                		public void actionPerformed(ActionEvent e) 
        	            {
                			Pisarz p = new Pisarz("", 0);
        	                baza.pisarze.add(p);
        	                JFrame nowaFrame = new JFrame("Dodanie pisarza");
        	                nowaFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        	                nowaFrame.setSize(400,300);
        	                
        	                JPanel nowaPanel = new PisarzSwing(p, baza);
        	                nowaFrame.add(nowaPanel);
        	                nowaFrame.setVisible(true);
        	            }
                	});
                pisarzeFrame.add(dodaj);
        ...
        obs_ed.addActionListener(new ActionListener() 
        {
        	public void actionPerformed(ActionEvent e)
        	{
        		JFrame obsyFrame = new JFrame("Edycja obserwatorow");
        		obsyFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); 
                obsyFrame.setSize(600, 100);
               	obsyFrame.setLayout(new GridLayout(2,1));
                
                Obserwator obsy [] = baza.obserwatorzy.toArray(new Obserwator[0]);
                JComboBox<Obserwator> wybor = new JComboBox<>(obsy);
                ...
                wybor.addActionListener(
        	        new ActionListener()
        	        {
        	            public void actionPerformed(ActionEvent e) 
        	            {
        	                Obserwator wybranyObs = (Obserwator) wybor.getSelectedItem();
        	                if(wybranyObs instanceof Wydawnictwo)
        	                {
        	                	JFrame obsFrame = new JFrame("Edycja obserwatora");
            	        		obsFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); 
            	                obsFrame.setSize(400, 300);
            	                
            	                
            	                JPanel obsPanel = new WydawnictwoSwing((Wydawnictwo)wybranyObs, baza);
            	                obsFrame.add(obsPanel);
                ...
                JButton dodaj = new JButton("Dodaj nowe wydawnictwo");
                dodaj.addActionListener(
                	new ActionListener()
                	{
                		public void actionPerformed(ActionEvent e) 
        	            {
                			Wydawnictwo w = new Wydawnictwo("", 0);
        	                baza.obserwatorzy.add(w);
        	                JFrame nowaFrame = new JFrame("Dodanie wydawnictwa");
        	                nowaFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        	                nowaFrame.setSize(400,300);
        	                
        	                JPanel nowaPanel = new WydawnictwoSwing(w, baza);
        	                nowaFrame.add(nowaPanel);
        	                nowaFrame.setVisible(true);
        	            }
                	});
                ...
                obsyFrame.setVisible(true);
        	}
        });
        
        JButton usun = new JButton("Usun baze danych");
